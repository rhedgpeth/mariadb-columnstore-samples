...
# /usr/bin/cpimport -m 2 -s ',' -E '"' columnstore_schema airports -l $SCHEMA_DIR/airports.csv
# /usr/bin/cpimport -m 2 -s ',' -E '"' columnstore_schema airlines -l $SCHEMA_DIR/airlines.csv
